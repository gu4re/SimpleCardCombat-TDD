 ...
 * @since 2023-03-07
 */
@DisplayName("Testing OpenLibraryService class ...")
public class OpenLibraryServiceTest {
	...
	@Test
	@DisplayName("Got 15 books from each topic with a limit of 15")
	...
	@Test
	@DisplayName("Got 'The Name of the Wind' book without problems")
